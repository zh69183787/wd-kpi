...
String configPath = Thread.currentThread().getContextClassLoader().getResource("kpiConfig.properties").getPath();
try {
...
<%! 
    ...
    private String toHex(byte[] buffer){  
     ...
     private void saveCookie(HttpServletResponse response,String Name,String value) throws UnsupportedEncodingException{
    		Cookie cookie = new Cookie("kpi_"+Name, java.net.URLEncoder.encode(value,"utf-8"));
			cookie.setPath("/");		
...
<html>
  ...
  if(action!=null&&action.equalsIgnoreCase("logout")){
  		Cookie cookie = new Cookie("kpi_token", null);  
        cookie.setMaxAge(0);  
     	cookie.setPath("/");	
        response.addCookie(cookie);	 
